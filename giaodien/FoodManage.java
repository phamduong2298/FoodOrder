...
public class FoodManage implements ActionListener {
	...
	private void initialize() {
		...
		btnDelete.setBounds(451, 156, 89, 23);
		frame.getContentPane().add(btnDelete);
		btnDelete.addActionListener(this);
		
		btnEdit = new JButton("Edit");
		btnEdit.setBounds(451, 236, 89, 23);
		...
		btnAdd.setBounds(451, 317, 89, 23);
	...
	public void delete(){
		...
		if (row<0){
			JOptionPane.showMessageDialog(null, "Chọn hàng để xóa!", "Error", JOptionPane.ERROR_MESSAGE);
			return;
		}
